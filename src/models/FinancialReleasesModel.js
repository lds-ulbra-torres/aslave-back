export default (sequelize, DataType) => {
  ...
  sequelize.models.fin_classifications.hasMany(FinancialReleases, {
    foreignKey: 'id_classification',
    targetKey: 'id_classification',
  })
  FinancialReleases.belongsTo(sequelize.models.fin_classifications, {
    foreignKey: 'id_classification',
    targetKey: 'id_classification',
  })
