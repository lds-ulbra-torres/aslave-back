export default (sequelize, DataType) => {
  ...
  StockInput.deleteProducts = async (products, id_stock) => await products.map( async product => {
    try {
  ...
  StockInput.addProducts = async (products, id_stock) => await products.map( async product => {
    try {
